module github.com/chatagent/server
...
replace (
	...
	github.com/go-playground/validator/v10 => github.com/go-playground/validator/v10 v10.10.0
	github.com/pelletier/go-toml/v2 => github.com/pelletier/go-toml/v2 v2.0.2
